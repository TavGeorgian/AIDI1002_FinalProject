...
model_options = ['bert','transformer_xl','elmo','use' ,'roberta']   
...
if __name__ == '__main__':
    ...
    if args.nlp_model == 'bert':
        ...
        word_ind_to_extract = -1  # GPT predictions are typically based on the last token
        nlp_features = get_gpt_layer_representations(args.sequence_length, text_array, remove_chars, word_ind_to_extract)
    else:
